...
export default function OurCleaningServices() {
  const features = [
    ...
    },
    {
      ...
      description:
        "Emergency cleaning services available when you need them most",
    },
    {
      icon: Clock,
    ...
    <section className="relative py-20 overflow-hidden">
      ...
      <div className="relative max-w-6xl mx-auto px-4">
        <div className="max-w-3xl">
          ...
          >
            Experience the difference with Stunning LCS - where professional
            excellence meets unmatched reliability. Our comprehensive cleaning
            solutions are designed to exceed your expectations every single
            time.
          </motion.p>
